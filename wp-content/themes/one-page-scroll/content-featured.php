...
'Lorem ipsum dolor sit amet, consectetur adipiscingelit. Integer sed magna vel velit dignissim luctus eu n urna. Dapibus ege-stas turpis. Praesent faucibus nisl sit amet nulla sollicitudin.'
 ...
 wp_nav_menu(array('theme_location'=>'home_page_sidebar_menu','depth'=>3,'fallback_cb' =>false,'container'=>'','menu_id'=>'home_page_sidebar_menu','menu_class'=>'home_page_sidebar_menu','link_before' => '', 'link_after' => '<span></span>','items_wrap'=> '<ul id="%1$s" class="%2$s">%3$s</ul>'));
}
