	 ...
	 $options[] = array(
	  ...
	  // background video
       ...
       $options[] = array('desc' => '</div>','class' => 'toggle_title','type' => 'info');
		...
		$options[] = array(	'desc' =>'<div class="options-section"><h3 class="groupTitle">'.__('Home Page & Blog Sidebar Menu options', 'onepagescroll').'</h3>',	'class' => 'toggle_option_group group_close','type' => 'info');
...
'Lorem ipsum dolor sit amet, consectetur adipiscingelit. Integer sed magna vel velit dignissim luctus eu n urna. Dapibus ege-stas turpis. Praesent faucibus nisl sit amet nulla sollicitudin.'
	 ...
	 $section_background = array(
	  ...
	  $options[] = array(	'desc' => '<div class="home-sections">', 'class' => '','id'=>'home-sections','type' => 'info');
		...
		$options[] = array(	'desc' => '<div class="options-section"><h3 class="groupTitle"><i class="fa fa-arrows"></i> '.sprintf(__('Section %d','onepagescroll'),($i+1)).'</h3>', 'class' => 'toggle_option_group home-section group_close','type' => 'info');
		
		$options[] = array(
		'name' => '',
		'desc' => '<div style="overflow:hidden; background-color:#eee;"><a data-section="'.$i.'" class="delete-section button-primary" style="float:right;" title="'.__('Delete', 'onepagescroll').'">'.__('Delete this section', 'onepagescroll').'</a></div>',
	   ...
	   $options[] = array('name' => __('Section Content', 'onepagescroll'),'id' => 'section_content_'.$i,'std' => $section_content[$i],'type' => 'editor','desc'=>__('If you have reordered the sections and found the section content is blank or can not be edited, please click the "Save Options" button to save options before you edit section content.', 'onepagescroll'));
	   $options[] = array('desc' => '</div>','class' => 'toggle_title','type' => 'info');
