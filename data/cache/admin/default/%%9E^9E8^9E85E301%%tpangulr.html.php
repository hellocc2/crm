<?php /* Smarty version 2.6.18, created on 2015-11-04 10:31:59
         compiled from tpangulr.html */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8" />
  ...
  <link rel="stylesheet" href="<?php echo $this->_tpl_vars['temp_url']; ?>
...
<body>
        ...
        <ul class="nav navbar-nav hidden-sm">
          ...
          <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle">
              ...
              <span translate="header.navbar.new.NEW">好评</span> <span class="caret"></span>
            </a>
           </li>
        </ul>
        <!-- / link and dropdown -->
  ...
  <!-- jQuery -->
  <script src="<?php echo $this->_tpl_vars['temp_url']; ?>
vendor/jquery/jquery.min.js"></script>
  <script src="<?php echo $this->_tpl_vars['temp_url']; ?>
vendor/jquery/bootstrap.js"></script>
