...
class PtsWidgetTodaydeals2 extends PtsWidgetPageBuilder {

	public $name = 'todaydeals2';
	public $group = 'opencart';
	
	public static function getWidgetInfo(){
		return array('label' => ('Today Deals'), 'explain' => 'Alow list products today deals on layout home 2', 'group' => 'opencart');
	}
