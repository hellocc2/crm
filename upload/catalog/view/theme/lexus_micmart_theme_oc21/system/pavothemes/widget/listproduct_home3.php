...
class PtsWidgetListproduct_home3 extends PtsWidgetPageBuilder {

		public $name = 'listproduct_home3';
		public $group = 'product';

		public static function getWidgetInfo(){
			return array('label' => ('Get List products'), 'explain' => 'this widget only support for layout home 3', 'group' => 'product'  );
		}
