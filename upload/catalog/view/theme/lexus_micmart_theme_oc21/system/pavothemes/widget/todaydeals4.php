...
class PtsWidgetTodaydeals4 extends PtsWidgetPageBuilder {

	public $name = 'todaydeals4';
	public $group = 'opencart';
	
	public static function getWidgetInfo(){
		return array('label' => ('Today Deals'), 'explain' => 'Alow list products today deals on layout home 4', 'group' => 'opencart');
	}
