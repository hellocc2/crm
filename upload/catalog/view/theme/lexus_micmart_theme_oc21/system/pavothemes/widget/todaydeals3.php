...
class PtsWidgetTodaydeals3 extends PtsWidgetPageBuilder {

	public $name = 'todaydeals3';
	public $group = 'opencart';
	
	public static function getWidgetInfo(){
		return array('label' => ('Today Deals'), 'explain' => 'Alow list products today deals on layout home 3', 'group' => 'opencart');
	}
