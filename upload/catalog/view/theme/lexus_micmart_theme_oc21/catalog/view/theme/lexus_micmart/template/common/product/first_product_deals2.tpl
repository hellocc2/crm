...
<div class="product-block item-default" itemtype="http://schema.org/Product" itemscope> 
  <div class="block-img text-center">
      ...
      <?php } ?>
      <div id="item_countdown_<?php echo $first_product['product_id']; ?>" class="item-countdown-v2 space-padding-lr-20"></div>
    ...
    <div class="product-meta">      
      ...
      <div class="bottom">
        ...
        <div class="bottom-last space-padding-t20">      
			...
			<div class="cart">            
			<button data-loading-text="Loading..." class="btn btn-primary btn-xs radius-5x" type="button" onclick="cart.addcart('<?php echo $first_product['product_id']; ?>');">
