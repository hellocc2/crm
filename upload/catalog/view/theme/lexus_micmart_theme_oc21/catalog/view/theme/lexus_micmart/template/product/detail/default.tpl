        ...
        <div class="product-info-bg">
            ...
            <div class="product-view col-lg-<?php echo $cols[1]; ?> col-md-6 col-sm-6 col-xs-12 ">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <?php } ?>  
                            <?php if ($manufacturer) { ?>
                                <li><span class="check-box text-primary"><i class="fa fa-check"></i></span><?php echo $text_manufacturer; ?> <a href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?></a></li>
                            <?php } ?>
                            <li><span class="check-box text-primary"><i class="fa fa-check"></i></span><?php echo $text_model; ?> <?php echo $model; ?></li>
                            <?php if ($reward) { ?>
                                <li><span class="check-box text-primary"><i class="fa fa-check"></i></span><?php echo $text_reward; ?> <?php echo $reward; ?></li>
                            <?php } ?>
                            <?php if ($points) { ?>
                                <li><span class="check-box text-primary"><i class="fa fa-check"></i></span><?php echo $text_points; ?> <?php echo $points; ?></li>
                            <?php } ?>
                        </ul>
                        <hr>                   
                        ...
                        <div class="product-meta">
                            <div class="clearfix">
                                ...
                                <div class="quantity-adder clearfix">
                                 <span class="pull-left quantity-title"><?php echo $objlang->get('entry_qty'); ?></span>     
                                ...
                                <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart space-padding-r5"></i><?php echo $button_cart; ?></button>
                                </div>
                                </div>
                                <div class="clearfix">
                                    <div class="wishlist pull-left space-padding-r20">  
                                    <a data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.addwishlist('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i><span><?php echo $button_wishlist; ?></span>
                                    </a>
                                    </div>

                                    <div class="compare pull-left">
                                    <a data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.addcompare('<?php echo $product_id; ?>');"><i class="fa fa-refresh"></i><span><?php echo $button_compare; ?></span></a>
                                    </div> 
                                </div>                              
