...
<div class="main-columns container space-20">
  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <div id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content" class="space-padding-0"><?php echo $content_top; ?>
    <div class="style-panel">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"><div class="input-group btn-block" style="max-width: 200px;">
                    ...
                    <button type="submit" data-toggle="tooltip" title="<?php echo $button_update; ?>" class="btn btn-default"><i class="fa fa-refresh"></i></button>
                    <button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-primary" onclick="cart.remove('<?php echo $product['cart_id']; ?>');"><i class="fa fa-times-circle"></i></button></span></div></td>
      ...
      <div class="buttons">
        ...
        <div class="pull-right"><a href="<?php echo $checkout; ?>" class="btn btn-default"><?php echo $button_checkout; ?></a></div>
      </div>
      </div>
