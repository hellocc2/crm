  ...
  <div class="block-img text-center">
    ...
    <div class="product-meta">      
      ...
      <div class="bottom">
        <div class="action">          
            <div class="wishlist">
                <button class="btn btn-dark btn-sm " type="button" title="<?php echo $objlang->get("button_wishlist"); ?>" onclick="wishlist.addwishlist('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i><span class=""><?php echo $objlang->get('button_wishlist'); ?></span></button> 
              </div>      
              
              <div class="compare">     
                <button class="btn btn-dark btn-sm" type="button" title="<?php echo $objlang->get("button_compare"); ?>" onclick="compare.addcompare('<?php echo $product['product_id']; ?>');"><i class="fa fa-refresh"></i><span class=""><?php echo $objlang->get('button_compare'); ?></span></button> 
              </div>  
               <!-- zoom image-->
                <?php if( isset($categoryPzoom) && $categoryPzoom ) { $zimage = str_replace( "cache/","", preg_replace("#-\d+x\d+#", "",  $product['thumb'] ));  ?>
                <div class="zoom ">
                  <a href="<?php echo $zimage;?>" class="product-zoom btn btn-dark btn-sm" title="<?php echo $product['name']; ?>">
              ...
              <div class="quickview">
                 <a class="iframe-link  btn btn-dark btn-sm" href="<?php echo $ourl->link('themecontrol/product','product_id='.$product['product_id']);?>" title="<?php echo $objlang->get('quick_view'); ?>">
                 <i class="fa fa-eye"></i>
        ...
        <div class="bottom-last space-padding-t20">      
          ...
          <div class="cart">            
            <button data-loading-text="Loading..." class="btn btn-primary btn-md radius-5x" type="button" onclick="cart.addcart('<?php echo $product['product_id']; ?>');">
...
<div id="item_countdown_<?php echo $product['product_id']; ?>" class="item-countdown-v2 space-padding-lr-20 space-padding-b20"></div>
