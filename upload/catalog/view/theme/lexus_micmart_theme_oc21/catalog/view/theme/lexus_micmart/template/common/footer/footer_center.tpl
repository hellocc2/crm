  ...
  <div class="container">
    <div class="inside space-padding-tb-40">
      <div class="row">
        ...
        <div class="col-md-2 col-sm-6 col-xs-12 column">
          <?php if( $content=$helper->getLangConfig('widget_popular') ) {?>
          <?php echo $content; ?>            
          <?php } ?> 
        </div>
        <div class="col-md-2 col-sm-6 col-xs-12 column">
          <?php if( $content=$helper->getLangConfig('widget_brands') ) {?>
              <?php echo $content; ?>
          <?php } ?> 
        </div>
         <div class="col-md-2 col-sm-6 col-xs-12 column">
          <div class="panel">
            <div class="panel-heading"><h5 class="panel-title"><?php echo $text_service; ?></h5></div>
            <div class="panel-body">
              <ul class="list-unstyled">
