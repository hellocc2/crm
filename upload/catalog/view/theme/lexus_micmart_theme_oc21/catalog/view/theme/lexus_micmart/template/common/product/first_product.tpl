...
<div class="product-block item-default" itemtype="http://schema.org/Product" itemscope> 
  <div class="block-img text-center">
    ...
    <div class="product-meta">      
      <div class="top">
         <h3 class="name" ><a href="<?php echo $first_product['href']; ?>"><?php echo $first_product['name']; ?></a></h3>
        ...
        <p class="description" itemprop="description"><?php echo utf8_substr( strip_tags($first_product['description']),0,220);?>...</p>
        <?php } ?> 
      
        <?php if (isset($first_product['price'])) { ?>
        <div class="price">
          <?php if (!$first_product['special']) {  ?>
