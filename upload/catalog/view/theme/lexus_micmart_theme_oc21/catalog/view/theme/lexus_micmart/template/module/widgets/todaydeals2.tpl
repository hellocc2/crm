...
?>
<div class="productdeals productdeals-v2">
	<div class="box-content">
		...
		<div class="row bg-white">
			...
			<!-- col2 first product -->
			<div class="col-xs-12 col-sm-8 col-md-6 col-lg-6 product-v2 border-right">
				<?php require( DIR_TEMPLATE.$config->get('config_template').'/template/common/product/first_product_deals2.tpl');?>
			</div>

			<!-- col3 -->
			
			<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 sidebar effect-carousel-v2"  id="widget-todaydeals-<?php echo $id;?>">
			...
			<!-- col1 banner-->
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 effect-v10 hidden-sm hidden-xs <?php echo $img_class; ?>">
				<?php if(!empty($banner)) { ?>
