...
$helper->triggerUserParams( array('headerlayout','productlayout','productdetail') );
/* Add scripts files */
...
$headerlayout = $helper->getConfig('header','version-1');


$template_layout = $helper->getConfig('template_layout');
$skin = $helper->getConfig('skin');

$social_id = $helper->getConfig('social_id', 'ra-5350ac7b76c3e2f6');
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=<?php echo $social_id; ?>" async="async"></script>
