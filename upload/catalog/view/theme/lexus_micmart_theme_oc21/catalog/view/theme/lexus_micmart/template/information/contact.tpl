...
<div class="main-columns container space-20">
  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <div id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content" class="space-padding-0"><?php echo $content_top; ?><div class="well">
      ...
      <?php } ?>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal bg-white space-padding-20">
        <div class="row">
              <?php 
