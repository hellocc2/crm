<?php
	...
	$id = rand(1,9)+rand();
?>
<div class="widget bg-carousel">
	<div class="<?php echo $addition_cls;?> <?php if ( isset($stylecls)&&$stylecls) { ?>box-<?php echo $stylecls; ?><?php } ?>">
	<?php if( $show_title ) { ?>
	...
	<div class="list box-products block-content effect-carousel-v2" id="product_list<?php echo $id;?>">
		...
		<?php } ?>
			<div class="carousel-inner  products-block product-grid">
