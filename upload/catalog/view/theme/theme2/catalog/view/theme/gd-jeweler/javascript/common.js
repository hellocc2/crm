/* http://www.opencart.cn [build: 2016/08/10 16:47:45] */
...
$(document).ready(function() {
  //header
  var activ=$(".main-menu li").hasClass("activ");
if (!activ) {
  $(".main-menu li:first").addClass("activ");
}
  ...
  $('#search input[name=\'search\']').parent().find('button').on('click', function() {
    ...
    var value = $(this).parent().siblings('input[name=\'search\']').val();
